...
export const getAvailableTimes = actionClient
  ...
  .action(async ({ parsedInput }) => {
    ...
    //Verificar se o médico tem disponibilidade para o dia, se o dia está entre o dia inicial e o dia final de disponibilidade
    ...
    // Verificar Todos os agendamentos do médico
    const appointments = await db.query.appointmentsTable.findMany({
      where: eq(appointmentsTable.doctorId, parsedInput.doctorId),
    });
    // PEgar o agendamento apenas do dia selecionado, para verificar se é o mesmo dia do date que tá vindo
